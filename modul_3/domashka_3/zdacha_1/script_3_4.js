	...
	methods:{
		search:function(event){
			...
			for(i=0; i < this.articles.length;i++){
				if (src=="") this.articles[i].visible = true;
					else this.articles[i].visible = false;
				let cont = this.articles[i].titel.toLowerCase();
				console.log(cont);
				if(cont.includes(src.toLowerCase())){
						console.log('545454');
						this.articles[i].visible = true;
					}
			}			
		}
	},
