...
http.createServer((request, response) => {
   ...
   // if (process.argv[2] === 'en') pathname = 'en.html';
   // if (process.argv[2] === 'ru') pathname = 'ru.html'; else pathname = 'ru.html'
  if (process.env.LANG === 'ru_RU') pathname = 'ru.html'; else pathname = 'en.html'
